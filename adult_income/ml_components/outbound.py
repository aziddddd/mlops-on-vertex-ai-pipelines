...
def update_model_league(
    ...
    if update_mode == 'train':
        ...
        new_model_league.loc[new_model_league['tag']=='production',:]['pred_bq_paths'] = new_model_league.loc[new_model_league['tag']=='production',:]['pred_bq_paths'].apply(
            lambda row: row.append(bq_path)
        )
        
        new_model_league.loc[new_model_league['tag']=='production', 'pred_job_id'] = job_id
        new_model_league.loc[new_model_league['tag']=='production',:]['pred_job_ids'] = new_model_league.loc[new_model_league['tag']=='production',:]['pred_job_ids'].apply(
            lambda row: row.append(bq_path)
        )
